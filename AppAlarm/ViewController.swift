...
//            shapeView.bottomAnchor.constraint(equalTo: view.bottomAnchor),
//            shapeView.topAnchor.constraint(equalTo: view.topAnchor),
            shapeView.heightAnchor.constraint(equalToConstant: 250),
//            shapeView.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 0.5),
//            shapeView.rightAnchor.constraint(equalTo: view.rightAnchor, constant: 0.5),
//            shapeView.topAnchor.constraint(equalTo: view.topAnchor, constant: 0.5),
//            shapeView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 0.5),
//            shapeView.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.5),
//            shapeView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.5),
            shapeView.widthAnchor.constraint(equalToConstant: 290)
        ])
